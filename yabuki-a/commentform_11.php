<html>
    ...
    <body>
        <table border="1" width="120" height="120">
            <tr>
                <td>クリックした場所の店名
                    <iframe src="shopnameview_11.php" width="500" height="60">
                    </iframe>
                </td>
            </tr>
            <tr>
                <td>食べログへ飛べるリンク
                    <iframe src="linkview_11.php" width="500" height="60">
                    </iframe>
                </td>
            </tr>
            <tr>
                <td>（コメント）
                    ...
                    <iframe src="commentsview_11.php" width="500" height="200">
                    </iframe>
                    <form action="comment_11.php" method="post">
                        <dl>
                            <dt>名前</dt>
